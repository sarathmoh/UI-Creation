...
const Content = () => {
  ...
  return (
    <div className="grid grid-cols-12 grid-rows-[1.5fr_1.3fr_2.3fr] h-lvh gap-5 max-sm:h-auto max-sm:grid-rows-1 sm:max-lg:grid-rows-4 sm:max-lg:gap-5">
      ...
      <div className="col-start-1 col-end-9 gap-5 row-start-2 row-end-3 grid grid-cols-3 max-sm:col-end-13 max-sm:grid-cols-1 max-sm:grid-rows-3 sm:max-lg:col-end-13">
        <div>
          {" "}
      ...
      <div className="col-start-9 col-end-13  row-start-2 row-end-4  grid grid-rows-[1fr_1fr] grid-cols-1 gap-5 max-sm:col-start-1 max-sm:row-auto sm:max-lg:col-start-1 sm:max-lg:row-start-3  sm:max-lg:row-end-4 sm:max-lg:grid-cols-2 sm:max-lg:row-auto ">
        <div>
      ...
      <div className="col-start-1  col-end-9   row-start-3 row-end-4 max-sm:col-end-13 max-sm:row-auto sm:max-lg:col-end-13 sm:max-lg:row-start-4 sm:max-lg:row-end-5">
